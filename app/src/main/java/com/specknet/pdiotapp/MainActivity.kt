...
import com.specknet.pdiotapp.live.LivePredictingActivity
import com.specknet.pdiotapp.onboarding.OnBoardingActivity
import com.specknet.pdiotapp.user.ProfileActivity
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var modelPredictionButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        modelPredictionButton = findViewById(R.id.model_button)
    ...
    fun setupClickListeners() {
        modelPredictionButton.setOnClickListener {
            val intent = Intent(this, LivePredictingActivity::class.java)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.show_profile) {
            val introIntent = Intent(this, ProfileActivity::class.java)
            startActivity(introIntent)
            return true
        }
